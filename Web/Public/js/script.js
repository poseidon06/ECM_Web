...
(function myFunction() {
  ...
  document.querySelector(".nav-button").click(function () {
    document
      .querySelector(".nav-button, .side-nav, .nav-header, .nav-options")
  ...
  // closing the menu-overlay
  document.querySelector(".close, .menu-container").click(function () {
    document.querySelector(".menu-container").removeClass("displayed");
    return false;
  });
  // preventing clicks on the menu closing it for now because there is nothing inside yet.
  document.querySelector(".tab.menu-tab").click(function () {
    return false;
  });
  ...
  document.querySelector(window).scroll(function () {
    if (document.querySelector(window).scrollTop > 600) {
      document
        .querySelector(".nav-button, .search-button")
        .classList.add("black");
    } else {
      document
        .querySelector(".nav-button, .search-button")
